...
namespace Sierra::Editor
{
    ...
    bool GUI::IntInput(const char* label, int &value, bool canDrag, const InputFlags inputFlags)
    {
        return NumericInput<int>(label, value, canDrag, false, inputFlags);
    }
    ...
    bool GUI::UIntInput(const char* label, uint &value, bool canDrag, const InputFlags inputFlags)
    {
        return NumericInput<uint>(label, value, canDrag, false, inputFlags);
    }
    ...
    bool GUI::Checkbox(const char* label, uint &value)
    {
        bool boolValue;
    ...
    bool GUI::Dropdown(const char* label, uint &value, const char* *options, const uint optionCount, const bool* deactivatedFlags)
    {
        bool modified = false;
    ...
    void GUI::LineDiagram(const char* label, const float *values, const uint valueCount, const uint currentValueIndex, const char* text, const float minimumValue, const float maximumValue, const Vector2 &size)
    {
    ...
    void GUI::PopStyleColor(const uint count)
    {
    ...
    void GUI::PopStyleVariable(const uint count)
    {
    ...
    void GUI::SetNumericInputFormattingSpaceCount(const uint spaceCount)
    {
    ...
    uint GUI::GetID(const char* string)
    {
        return ImGui::GetID(string);
    }

    uint GUI::HashString(const char* string)
    {
    ...
    void GUI::OpenPopup(const char* popupName)
    {
    ...
    bool GUI::IntProperty(const char* label, int &value, const char* tooltip, const InputFlags inputFlags)
    {
        BeginProperty(label, tooltip);
        bool modified = NumericInput<int>(IDBuffer, value, true, false, inputFlags, ImDrawFlags_RoundCornersAll, GImGui->Style.FrameRounding);
        EndProperty();
    ...
    bool GUI::UIntProperty(const char* label, uint &value, const char* tooltip, const InputFlags inputFlags)
    {
        BeginProperty(label, tooltip);
        bool modified = NumericInput<uint>(IDBuffer, value, true, false, inputFlags);
        EndProperty();
    ...
    bool GUI::DropdownProperty(const char* label, uint &value, const char* *options, const uint optionCount, const bool* deactivatedFlags, const char* tooltip)
    {
        BeginProperty(label, tooltip);
    ...
    bool GUI::TextureProperty(const char* label, SharedPtr<Rendering::Texture> &texture, const char* tooltip)
    {
        BeginProperty(label, tooltip);
        ...
        {
            texture = Rendering::Texture::GetDefaultTexture(texture->GetTextureType());
            changed = true;
        }
