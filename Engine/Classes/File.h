...
namespace Sierra::Engine::Classes::File
{
    ...
    /// @brief Returns a given file path without the file name and extension at the end.
    ...
    std::string GetFileExtensionFromPath(const std::string &filePath, bool includeDot = false);
