...
namespace Sierra::Engine::Classes
{
    ...
    public:
        ...
        /* --- SETTER METHODS --- */
        static void SetGamePadMinimumStickSensitivity(float minimumSensitivity, uint32_t player = 1);
        static void SetGamePadMinimumLeftStickSensitivity(float minimumSensitivity, uint32_t player = 1);
        static void SetGamePadMinimumRightStickSensitivity(float minimumSensitivity, uint32_t player = 1);

        /* --- GETTER METHODS --- */
        /// \brief Checks whether a key on the keyboard is pressed.
        /// @param keyCode The key to check.
        static bool GetKeyPressed(uint32_t keyCode);
        ...
        static float GetVerticalMouseScroll();
        ...
        static bool GetGamePadButtonPressed(uint32_t gamePadButton, uint32_t player = 1);
        ...
        /// @param gamepadButton The button to check.
        /// @param player Which player's gamepad to use (also referred to as an ID of the gamepad).
        static bool GetGamePadButtonHeld(uint32_t gamePadButton, uint32_t player = 1);
        ...
        /// @param gamepadButton The button to check.
        /// @param player Which player's gamepad to use (also referred to as an ID of the gamepad).
        static bool GetGamePadButtonReleased(uint32_t gamePadButton, uint32_t player = 1);
        ...
        /// @param gamepadButton The button to check.
        /// @param player Which player's gamepad to use (also referred to as an ID of the gamepad).
        static bool GetGamePadButtonResting(uint32_t gamePadButton, uint32_t player = 1);
        ...
        /// if you are not familiar with the buttons and layout of gamepads.
        /// @param player Which player's gamepad to use (also referred to as an ID of the gamepad).
        static glm::vec2 GetGamePadLeftStickAxis(uint32_t player = 1);

        /// \brief Returns the a value between -1 and 1 indicating the current input on the horizontal axis of the left (LSB) stick.
        /// See also <a href="https://gist.github.com/palmerj/586375bcc5bc83ccdaf00c6f5f863e86 this link</a>
        /// if you are not familiar with the buttons and layout of gamepads.
        /// @param player Which player's gamepad to use (also referred to as an ID of the gamepad).
        static glm::vec2 GetGamePadRightStickAxis(uint32_t player = 1);
        ...
        /// if you are not familiar with the buttons and layout of gamepads.
        /// @param player Which player's gamepad to use (also referred to as an ID of the gamepad).
        static float GetHorizontalGamePadLeftStickAxis(uint32_t player = 1);
