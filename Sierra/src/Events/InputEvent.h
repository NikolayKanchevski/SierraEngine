...
namespace Sierra
{
    ...
    public:
        ...
        /* --- PROPERTIES --- */
            ...
            [[nodiscard]] inline std::string GetLogString() const override { return (std::stringstream() << "Key Pressed - [Key Name: " << GetKeyName(GetKey()) << " | Key Code: " << static_cast<int16>(GetKey()) << "]").str(); }
        #endif
    ...
    public:
        ...
        /* --- PROPERTIES --- */
        #if SR_ENABLE_LOGGING
            [[nodiscard]] inline std::string GetLogString() const override { return (std::stringstream() << "Key Released - [Key Name: " << GetKeyName(GetKey()) << " | Key Code: " << static_cast<int16>(GetKey()) << "]").str(); }
        #endif
    ...
    public:
        ...
        /* --- PROPERTIES --- */
        #if SR_ENABLE_LOGGING
            [[nodiscard]] inline std::string GetLogString() const override { return (std::stringstream() << "Mouse Button Pressed - [Button Name: " << GetMouseButtonName(GetMouseButton()) << " | Button Code: " << static_cast<uint32>(GetMouseButton()) << "]").str(); }
        #endif
    ...
    public:
        ...
        /* --- PROPERTIES --- */
        #if SR_ENABLE_LOGGING
            [[nodiscard]] inline std::string GetLogString() const override { return (std::stringstream() << "Mouse Button Released - [Button Name: " << GetMouseButtonName(GetMouseButton()) << " | Button Code: " << static_cast<uint32>(GetMouseButton()) << "]").str(); }
        #endif
    ...
    public:
        ...
        /* --- PROPERTIES --- */
        #if SR_ENABLE_LOGGING
            [[nodiscard]] inline std::string GetLogString() const override { return (std::stringstream() << "Mouse Scrolled - [Horizontal Delta: " << scroll.x << " | Vertical Delta: " << scroll.y << "]").str(); }
        #endif
