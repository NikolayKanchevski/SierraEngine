...
namespace Sierra
{
    ...
    class SIERRA_API UnixFileManager final : public FileManager
    {
    public:
        /* --- CONSTRUCTORS --- */
        ...
        /* --- COPY SEMANTICS --- */
        UnixFileManager(const UnixFileManager&) = delete;
        UnixFileManager& operator=(const UnixFileManager&) = delete;

        /* --- MOVE SEMANTICS --- */
        UnixFileManager(UnixFileManager&&) = delete;
        UnixFileManager& operator=(UnixFileManager&&) = delete;

        /* --- DESTRUCTOR --- */
        ~UnixFileManager() noexcept override = default;
