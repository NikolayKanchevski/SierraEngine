...
namespace Sierra
{
    ...
    public:
        /* --- POLLING METHODS --- */
        virtual void SubmitCommandBuffer(std::unique_ptr<CommandBuffer> &commandBuffer) const = 0;
        virtual void SubmitAndWaitCommandBuffer(std::unique_ptr<CommandBuffer> &commandBuffer) const = 0;
