...
namespace Sierra
{
    ...
    bool MetalDevice::IsImageFormatSupported(const ImageFormat format, const ImageUsage usage) const
    {
        ...
        switch (pixelFormat)
        {
            case MTL::PixelFormatR8Sint:                return !(usage & ImageUsage::ResolveAttachment) && !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatR8Uint:                return !(usage & ImageUsage::ResolveAttachment) && !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatR8Unorm:               return true;
            case MTL::PixelFormatR8Unorm_sRGB:          return true;
            case MTL::PixelFormatR16Sint:               return !(usage & ImageUsage::ResolveAttachment) && !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatR16Uint:               return !(usage & ImageUsage::ResolveAttachment) && !(usage & ImageUsage::SmoothSample);
            ...
            case MTL::PixelFormatR32Sint:               return !(usage & ImageUsage::ResolveAttachment) && !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatR32Uint:               return !(usage & ImageUsage::ResolveAttachment) && !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatR32Float:              return device->supportsFamily(MTL::GPUFamilyApple8) || !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatRG8Sint:               return !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatRG8Uint:               return !(usage & ImageUsage::SmoothSample);
            ...
            case MTL::PixelFormatRG16Sint:              return !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatRG16Uint:              return !(usage & ImageUsage::SmoothSample);
            ...
            case MTL::PixelFormatRG32Sint:              return device->supportsFamily(MTL::GPUFamilyApple7) && !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatRG32Uint:              return device->supportsFamily(MTL::GPUFamilyApple7) && !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatRG32Float:             return device->supportsFamily(MTL::GPUFamilyApple9);
            case MTL::PixelFormatRGBA8Sint:             return !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatRGBA8Uint:             return !(usage & ImageUsage::SmoothSample);
            ...
            case MTL::PixelFormatRGBA32Sint:            return !(usage & ImageUsage::ResolveAttachment) && !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatRGBA32Uint:            return !(usage & ImageUsage::ResolveAttachment) && !(usage & ImageUsage::SmoothSample);
            case MTL::PixelFormatRGBA32Float:           return device->supportsFamily(MTL::GPUFamilyApple9) || (!(usage & ImageUsage::SmoothSample) && !(usage & ImageUsage::ResolveAttachment));
            ...
            case MTL::PixelFormatDepth32Float:          return (device->supportsFamily(MTL::GPUFamilyApple3) || !(usage & ImageUsage::ResolveAttachment)) && (device->supportsFamily(MTL::GPUFamilyMac2) || !(usage & ImageUsage::SmoothSample));
            default:                                    break;
        }
