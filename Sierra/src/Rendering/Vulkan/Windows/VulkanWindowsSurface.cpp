...
namespace Sierra
{
    ...
    {
        SR_ERROR_IF(window.GetBackendType() != WindowingBackendType::Win32, "[Vulkan]: Cannot create a Windows surface for Vulkan using window [{0}], which has a platform backend, that differs from from [PlatformBackendType::Win32]", window.GetTitle());
