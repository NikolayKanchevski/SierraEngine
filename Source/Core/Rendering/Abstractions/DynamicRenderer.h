...
namespace Sierra::Rendering
{
    ...
    public:
        /* --- CONSTRUCTORS --- */
        explicit DynamicRenderer(const DynamicRendererCreateInfo &createInfo);
        ...
        /* --- GETTER METHODS --- */
        [[nodiscard]] inline uint32 GetColorAttachmentCount() const { return renderingInfo.colorAttachmentCount; }
        ...
        /* --- SETTER METHODS --- */
        void OverloadColorAttachment(uint32 index, UniquePtr<Image> &image);
