...
namespace Sierra::Rendering
{
    ...
    public:
        ...
        /* --- POLLING METHODS --- */
        void Draw(const UniquePtr<CommandBuffer> &commandBuffer, uint32 vertexCount);
        void DrawMesh(const UniquePtr<CommandBuffer> &commandBuffer, const UniquePtr<Engine::Mesh> &mesh);
