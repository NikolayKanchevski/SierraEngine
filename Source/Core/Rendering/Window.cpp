...
namespace Sierra::Rendering
{
    ...
    void Window::GlfwErrorCallback(int32 errorCode, const char* description)
    {
        ASSERT_WARNING("GLFW Error: {0}! Error code: {1}.", description, errorCode);
    }

    void Window::WindowResizeCallback(GLFWwindow *windowPtr, int32 newWidth, int32 newHeight)
    {
    ...
    void Window::WindowFocusCallback(GLFWwindow *windowPtr, int32 focused)
    {
        auto windowObject = GetGlfwWindowParentClass(windowPtr);
    ...
    void Window::WindowMinimizeCallback(GLFWwindow *windowPtr, int32 minimized)
    {
        auto windowObject = GetGlfwWindowParentClass(windowPtr);
    ...
    void Window::WindowMaximizeCallback(GLFWwindow *windowPtr, int32 maximized)
    {
        auto windowObject = GetGlfwWindowParentClass(windowPtr);
