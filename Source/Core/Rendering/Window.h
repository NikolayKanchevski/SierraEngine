...
namespace Sierra::Rendering
{
    ...
    private:
        ...
        /* --- CALLBACKS --- */
        static void GlfwErrorCallback(int32 errorCode, const char* description);
        static void WindowResizeCallback([[maybe_unused]] GLFWwindow* windowPtr, int32 newWidth, int32 newHeight);
        static void WindowFocusCallback([[maybe_unused]] GLFWwindow* windowPtr, [[maybe_unused]] int32 focused);
        static void WindowMinimizeCallback([[maybe_unused]] GLFWwindow* windowPtr, [[maybe_unused]] int32 minimized);
        static void WindowMaximizeCallback([[maybe_unused]] GLFWwindow* windowPtr, [[maybe_unused]] int32 maximized);
