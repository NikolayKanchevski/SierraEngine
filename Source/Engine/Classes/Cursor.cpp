...
namespace Sierra::Engine
{
    ...
    Vector2 Cursor::GetCursorPositionNormalized()
    {
        ...
        return { cursorPosition.x / static_cast<float>(Window::GetCurrentlyFocusedWindow()->GetWidth()), cursorPosition.y / static_cast<float>(Window::GetCurrentlyFocusedWindow()->GetHeight()) };
    }
