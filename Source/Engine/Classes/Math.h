...
namespace Sierra::Engine::Math
{
    ...
    template<typename T, ENABLE_IF(IsTypeNumeric<T>)>
    [[nodiscard]] inline T Round(T value, int32 decimalPlaces = 0)
    {
    ...
    [[nodiscard]] inline int32 FindClosestMultipleOfN(const int32 number, const int32 multiple)
    {
    ...
    /// @param number What number to find the closes multiple of.
    [[nodiscard]] inline int32 FindClosestMultipleOf4(const int32 number)
    {
    ...
    /// @param number What number to find the closes multiple of.
    [[nodiscard]] inline int32 FindClosestMultipleOf16(const int32 number)
    {
