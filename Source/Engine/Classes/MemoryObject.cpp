...
namespace Sierra::Engine
{
    ...
    MemoryObject::MemoryObject(const uint64 elementSize, const uint32 count)
    ...
    {
        // Count equal to 0 means that memory will be allocated from outside and this object will be used as a wrapper
    }
